...
上面的思路可行，但是稍显复杂。
 ...
 [](https://pic.leetcode-cn.com/4e9a1eff10f236e6b9ee7427be7a3a8fbb6fb48be55ddd764d799eb23da1b6a1.jpg)
（图 5）
...
实际上这个过程有点类似`归并排序`中的**治**，而上面我们分别计算 num1 和 num2 的最大数的过程类似`归并排序`中的**分**。
 ...
 [](https://pic.leetcode-cn.com/fc53b51cf5512ce91ec509e8c80f383ab9f2b66a21c0d5fa397f744ead64e991.jpg)
（图 6）
...
以合并 [6] 和 [9,5,8,3] 为例，图解过程如下：
 ...
 [](https://pic.leetcode-cn.com/908c371d98f7eb11c30643694fa0fef94720c67bd77e832506ca0228f7d99b3f.jpg)
（图 7）
